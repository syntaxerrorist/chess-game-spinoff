...
{
    /// <summary>
    /// Represents a Builder piece in the game.
    /// </summary>
    public class Builder : Piece
        {
            ...
            /// <param name="initialSquare">The initial square occupied by the Builder.</param>
            public Builder(Player player, Square initialSquare) : base(player, initialSquare)
            {
            }

            /// <summary>
            /// Determines whether the Builder can attack the specified square.
            /// </summary>
            /// <param name="targetSquare">The target square to check for attack.</param>
            /// <returns><c>true</c> if the Builder can attack the target square; otherwise, <c>false</c>.</returns>
            public override bool CanAttack(Square targetSquare)
            {
                // if any of these are true, return false meaning Builder doesn't have a valid attack
                if (Square == null ||
                    targetSquare.IsFree ||
            ...
            /// <summary>
            /// Determines whether the Builder can move to the specified square.
            /// </summary>
            /// <param name="targetSquare">The target square to check for movement.</param>
            /// <returns><c>true</c> if the Builder can move to the target square; otherwise, <c>false</c>.</returns>
            ...
            /// <summary>
            /// Determines whether the Builder can swap positions with the specified square.
            /// </summary>
            /// <param name="targetSquare">The square to swap positions with.</param>
            /// <returns>
            ///   <c>false</c> since the Builder cannot perform swapping.
            /// </returns>
